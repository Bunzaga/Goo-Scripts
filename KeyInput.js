define([], function(){
	...
	var stringToCode = {"backspace":8,"tab":9,"enter":13,"shift":16,"ctrl":17,"alt":18,"pause":19,"caps":20,"esc":27,"space":32,"page up":33,"page down":34,"end":35,"home":36,
	...
	// function which converts key strings to codes
	KeyInput.toKeyCode = function(keyString){
		return stringToCode[keyString];
	}
	Object.freeze(KeyInput.toKeyCode);

	KeyInput.bind = function(keyCode, callback){
		var key = typeof keyCode === 'number' ? keyCode : KeyInput.toKeyCode(keyCode);
		keys[key] = false;
		if(callback){
